...
public class TelaExecucao extends javax.swing.JFrame {
    ...
    private void btnStepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStepActionPerformed
        short shPosicao = 0;
        if(bPrimeiroStep){ //s√≥ chama o codificador na primeira chamada do botao, √© zera o ip
            mvm.halt = false;
            ...
            String sPosicao = JOptionPane.showInputDialog(this, "Digite o endere√ßo de carga.", null);  
            if(sPosicao == null || sPosicao.equals(""))
                return;
            while(VerificaEnderecoDeCarga(sPosicao) == false){
                JOptionPane.showMessageDialog(this, "Entrada de dados inv√°lida");
                sPosicao = JOptionPane.showInputDialog(this, "Digite o endere√ßo de carga.", null);  
                if(sPosicao == null || sPosicao.equals(""))
                    return;
            }
            ...
            if(iPosicao < 1025)
                ...
                JOptionPane.showMessageDialog(this, "Endere√ßo de carga muito elevado.");
                return;
            }
            ...
            /**
             * A funÁ„o single-step (passo-a-passo) sÛ deve funcionar se o bit UM 0b00000010 do registrador de flags estiver ligado.
             *  Esta opÁ„o pode ser feita atravÈs da interface com o usu·rio, atravÈs da instruÁ„o setbit 1;
             */
